...
public class QR2 implements Runnable, ThreadFactory {

    private final Executor executor = Executors.newSingleThreadExecutor(this);
    private Webcam webcam = null;
    private String lastResultText = null; // Armazena o último resultado para evitar repetição
    ...
    public void run() {
        do {
            ...
            if (result != null) {
                String currentResultText = result.getText();
                // Verifica se o resultado atual é diferente do último resultado lido
                if (!currentResultText.equals(lastResultText)) {
                    lastResultText = currentResultText;
                    System.out.println("QR Code detectado: " + lastResultText);
                }
            }
